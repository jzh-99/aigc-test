    ...
    <aside className="space-y-4 rounded-2xl border bg-card/80 p-4">
        ...
        <div className="overflow-hidden rounded-xl border bg-background shadow-sm">
          <div className={`${previewFrameClass} bg-black`}>
            {selectedSegment?.videoUrl ? (
              ...
              <div className="flex h-full w-full flex-col items-center justify-center gap-2 bg-primary/15 px-4 text-center text-xs text-primary">
      ...
      <div className="space-y-2 border-t pt-3">
        {generatingVideoCount > 0 && (
          <div className="rounded-lg bg-primary/15 px-3 py-2 text-xs text-primary">
