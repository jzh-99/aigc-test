      ...
      <Popover.Root open={open} onOpenChange={setOpen}>
        <Popover.Trigger asChild>
          ...
          >
            ...
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-muted/50 shrink-0">
              <ModelBrandIcon avatar={currentModel?.avatar} modelCode={currentModel?.code ?? videoModel} size={44} />
            </div>
        ...
        <Popover.Portal>
          <Popover.Content
            ...
            align="start"
            sideOffset={6}
            className="z-[120] max-h-72 w-[var(--radix-popover-trigger-width)] overflow-y-auto rounded-xl border border-white/15 bg-card/40 p-2 shadow-2xl shadow-black/30 backdrop-blur-2xl ring-1 ring-white/10 animate-in fade-in-0 zoom-in-95"
          >
