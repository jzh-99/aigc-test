...
interface ShotVideoCardProps {
  shot: Shot
  referenceImages: string[]   // resolved from character/scene images
...
function ShotVideoCard({ shot, referenceImages, videoUrl, aspectRatio, workspaceId, onVideoReady, registerGenerate }: ShotVideoCardProps) {
  ...
  }, [shot, referenceImages, aspectRatio, workspaceId, onVideoReady])
      ...
      <div className="w-[260px] shrink-0 border-r p-5 space-y-4 overflow-y-auto">
        ...
        {pendingCount > 0 && (
          ...
          >
            ...
            {batchRunning ? '批量生成中…' : `批量生成 (${pendingCount})`}
          </button>
        )}
