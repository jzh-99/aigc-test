...
const MODEL_REVERSE_MAP: Record<string, { modelType: 'gemini' | 'gpt-image-2' | 'nano-banana-pro' | 'seedream-5.0-lite' | 'seedream-4.5' | 'seedream-4.0'; resolution: '1k' | '2k' | '4k' }> = {
  ...
  'nano-banana-pro':     { modelType: 'nano-banana-pro', resolution: '1k' },
  'nano-banana-pro-2k':  { modelType: 'nano-banana-pro', resolution: '2k' },
  'nano-banana-pro-4k':  { modelType: 'nano-banana-pro', resolution: '4k' },
