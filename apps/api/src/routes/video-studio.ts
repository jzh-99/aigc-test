  ...
  "shots": [
    {
      ...
      "cameraMove": "缓慢推进至中景",
      "duration": 5,
      "visualPrompt": "[李明]站在[咖啡馆]门口，缓缓转身，嘴角上扬说：'你来了。'[王芳]从画面左侧轻盈走入，步伐自然。暖黄色室内光，侧逆光勾勒轮廓。镜头从全景缓慢推进至中景，稳定运镜无抖动。电影感，治愈清新风格，4K超高清，细节丰富。画面稳定流畅，面部清晰不变形，人体结构正常，无文字伪影，无多余手指。"
    }
  ]
}`
