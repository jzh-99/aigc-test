...
export function getStorageRuntimeInfo() {
  ...
  return {
    ...
    tosBucket: process.env.TOS_BUCKET ?? null,
    s3EndpointProtocol: getUrlProtocol(process.env.S3_ENDPOINT),
    s3PublicUrlProtocol: getUrlProtocol(process.env.S3_PUBLIC_URL),
